package org.example.irpc.framework.core.spi;
...
/**
 * @Author liutingfeng
 * @Date 2023/4/21 11:13 AM
 */
public class ExtensionLoader {
    public static final String EXTENSION_LOADER_DIR_PREFIX = "META-INF/irpc/";
    ...
    public void loadExtension(Class clazz) throws IOException,ClassNotFoundException {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                String interfaceName = lineArr[0];
                String implClassName = lineArr[1];
                classMap.put(interfaceName, Class.forName(implClassName));
            }
